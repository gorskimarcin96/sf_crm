...
class PutTest extends ApiTestCase
{
    ...
    {
        $response = $this->getClient()->request('PUT', '/api/instance_lists/c904a712-1730-11ee-be56-0242ac120002', [
    ...
    {
        $response = $this->getClient()->request('PUT', '/api/instance_lists/c904b18a-1730-11ee-be56-0242ac120002', [
            'auth_bearer' => $this->getUserToken('user_1@user.test'),
            'body' => json_encode(['name' => 'list name updated', 'instanceUuid' => 'ffc05eac-0e09-11ee-be56-0242ac120002']),
            'headers' => [
                'Accept' => 'application/json',
    ...
    {
        $response = $this->getClient()->request('PUT', '/api/instance_lists/c904b02c-1730-11ee-be56-0242ac120002', [
            'auth_bearer' => $this->getUserToken('user_1@user.test'),
            'body' => json_encode(['name' => 'list name updated', 'instanceUuid' => 'ffc05eac-0e09-11ee-be56-0242ac120002']),
            'headers' => [
                'Accept' => 'application/json',
