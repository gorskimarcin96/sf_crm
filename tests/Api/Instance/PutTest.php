...
class PutTest extends ApiTestCase
{
    ...
    {
        $response = $this->getClient()->request('PUT', '/api/instances/1', [
    ...
    {
        $response = $this->getClient()->request('PUT', '/api/instances/0', [
            'auth_bearer' => $this->getUserToken('user_1@user.test'),
            'body' => json_encode(['name' => 'instance name updated']),
            'headers' => [
                'Accept' => 'application/json',
    ...
    {
        $response = $this->getClient()->request('PUT', '/api/instances/2', [
            'auth_bearer' => $this->getUserToken('user_1@user.test'),
            'body' => json_encode(['name' => 'instance name updated']),
            'headers' => [
                'Accept' => 'application/json',
