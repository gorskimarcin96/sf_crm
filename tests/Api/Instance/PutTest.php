...
class PutTest extends ApiTestCase
{
    ...
    {
        $response = $this->getClient()->request('PUT', '/api/instances/ffc05eac-0e09-11ee-be56-0242ac120002', [
    ...
    {
        $response = $this->getClient()->request('PUT', '/api/instances/04c09400-e396-4eec-808d-339200e588a2', [
            'auth_bearer' => $this->getUserToken('user_1@user.test'),
            'body' => json_encode(['name' => 'instance name updated']),
            'headers' => [
                'Accept' => 'application/json',
    ...
    {
        $response = $this->getClient()->request('PUT', '/api/instances/ffc05fc4-0e09-11ee-be56-0242ac120002', [
            'auth_bearer' => $this->getUserToken('user_1@user.test'),
            'body' => json_encode(['name' => 'instance name updated']),
            'headers' => [
                'Accept' => 'application/json',
